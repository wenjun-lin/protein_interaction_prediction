...
for file in PDBList:
    try:
        ...
        dis_a1, dis_a2, dis_a3, dis_a4, dis_a5, dis_a6, dis_a7, dis_a8 = feature_extraction_spacial(sequence_a)
        dis_b1, dis_b2, dis_b3, dis_b4, dis_b5, dis_b6, dis_b7, dis_b8 = feature_extraction_spacial_b(sequence_b)
        ...
        string_aa = string1a + ',' + string2a + ',' + string3a + ',' + string4a + ',' + string5a + ',' + string6a + ',' + string7a + ',' + string8a + ',' + '1'
        string_bb = string1b + ',' + string2b + ',' + string3b + ',' + string4b + ',' + string5b + ',' + string6b + ',' + string7b + ',' + string8b + ',' + '1'
        with open("result_interface_spacial.txt", "a") as f:
            f.write(string_aa + "\n")
            f.write(string_bb + "\n")
        ...
        with open("result_test_interface03_spacial.txt", "a") as f:
            f.write(string1 + "\n")
