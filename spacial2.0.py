...
string_aa = string1a + ',' + string2a + ',' + string3a + ',' + string4a + ',' + string5a + ',' + string6a + ',' + string7a + ','+ string8a
string_bb = string1b + ',' + string2b + ',' + string3b + ',' + string4b + ',' + string5b + ',' + string6b + ',' + string7b + ','+ string8b
print(string_aa)
print(string_bb)
